...
<div class="br-pageheader pd-y-15 pd-l-20">
  <nav class="breadcrumb pd-0 mg-0 tx-12">
    ...
    <span class="breadcrumb-item active">Subir formato</span>
  </nav>
</div><!-- br-pageheader -->
<div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
  <h4 class="tx-gray-800 mg-b-5">Subir formato</h4>
  <p class="mg-b-0"></p>
</div>
...
<div class="br-pagebody">
  <div class="br-section-wrapper col-md-12">
    ...
    <div class="col-md-6 col-md-offset-2" style="text-align: center;">
      ...
      <h2>Selecciona el formato</h2><br>
      <input type="file" name=""><br><br>
      <input type="submit" name="" class="btn btn-info" value="Subir formato">

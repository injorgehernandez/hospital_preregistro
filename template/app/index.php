...
<html lang="en">
  <head>
    ...
    <title>Hospital Puerta de Hierro</title>
  ...
  <body>
     ...
     <!-- ########## START: LEFT PANEL ########## -->
    <div class="br-logo"><img src="../img/logo-hospitales.png" class="logo-main"></a></div>
    <div class="br-sideleft overflow-y-auto">
      <label class="sidebar-label pd-x-15 mg-t-20">Hospitales Puerta de Hierro</label>
      <div class="br-sideleft-menu">
        <a href="#" class="br-menu-link active" onclick="cargaContenido('resumen_preregistros.php')">
        ...
        <a href="#" class="br-menu-link" onclick="cargaContenido('resumen_citas.php')">
          <div class="br-menu-item">
            <i class="menu-item-icon  icon ion-ios-list-outline tx-22"></i>
            <span class="menu-item-label">Citas</span>
          </div><!-- menu-item -->
        </a><!-- br-menu-link -->



        <a href="#" class="br-menu-link" onclick="cargaContenido('chat.php')">
          <div class="br-menu-item">
            <i class="menu-item-icon  icon ion-ios-list-outline tx-22"></i>
            <span class="menu-item-label">Subir formato</span>
          </div><!-- menu-item -->
        </a><!-- br-menu-link -->
   ...
   <!-- ########## START: HEAD PANEL ########## -->
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        //cargaContenido("formulario_preregistro.php");

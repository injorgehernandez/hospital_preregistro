...
<div class="br-pageheader pd-y-15 pd-l-20">
  <nav class="breadcrumb pd-0 mg-0 tx-12">
    ...
    <span class="breadcrumb-item active">Controversias</span>
  </nav>
</div><!-- br-pageheader -->
<div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
  <h4 class="tx-gray-800 mg-b-5">Resumen de Controversias</h4>
  <p class="mg-b-0"></p>
</div>
      ...
      <table id="datatableUbicaciones" class="table display responsive nowrap">
        <thead>
          <tr>
            ...
            <th class="wd-20p">Actor</th>
            <th class="wd-30p">Demandado</th>
            <th class="wd-30p">Asunto</th>
            <th class="wd-30p">Fecha</th>
  ...
  <div class="modal-dialog modal-dialog-vertical-center modal-lg" role="document">
    <div class="modal-content bd-0 tx-14">
      ...
      <div class="modal-header pd-y-20 pd-x-25">
        <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Seguimiento controversia</h6>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="control-label">Resolución de prestigio</label>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="control-label">Fecha de la resolución de prestigio</label>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="control-label">Sentido de la resolución de prestigio</label>
                        <Select class="form-control valid" type="text" name="apellido_materno" required="true" placeholder="" aria-required="true"  value="<?=$apellido_materno?>"></Select>
                    </div>
                </div>

                <div class="col-md-12">
                    <div class="form-group">
                        <label class="control-label">Motivo de la resolución de prestigio:</label>
                        <input class="form-control valid" type="text"  name="apellido_paterno" required="true" placeholder="" aria-required="true"  value="<?=$apellido_paterno?>">
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="control-label">Calificación actor:</label>
                        <Select class="form-control valid" type="text" name="apellido_materno" required="true" placeholder="" aria-required="true"  value="<?=$apellido_materno?>"></Select>
                    </div>
                </div>
                 ...
                 <div class="col-md-12">
                    <div class="form-group">
                        <label class="control-label">Calificación demandado:</label>
                        <Select class="form-control valid" type="text" name="apellido_materno" required="true" placeholder="" aria-required="true"  value="<?=$apellido_materno?>"></Select>
                    </div>
                </div>
...
<div id="modaldemo2" class="modal fade">
  ...
  <div class="modal-dialog modal-dialog-vertical-center modal-lg" role="document">
    <div class="modal-content bd-0 tx-14">
      <form id="guardar_usuario" method="post" enctype="multipart/form-data"> 
      <div class="modal-header pd-y-20 pd-x-25">
        <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Calcular Honorarios</h6>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
        ...
        <div class="form-layout">
          ...
          <div class="content">    
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="control-label">Monto litigio</label>

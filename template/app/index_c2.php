  ...
  <body>
    ...
    <div class="br-sideleft overflow-y-auto">
      ...
      <div class="br-sideleft-menu">
        <a href="#" class="br-menu-link active" onclick="cargaContenido('perfil2.php')">
        ...
        <a href="#" class="br-menu-link" onclick="cargaContenido('resumen_clientes.php')">
          <div class="br-menu-item">
          ...
          <a href="#" class="br-menu-link" onclick="cargaContenido('resumen_controversias.php')">
          <div class="br-menu-item">
            <i class="menu-item-icon  icon ion-ios-list-outline tx-22"></i>
            <span class="menu-item-label">Controversias</span>
          </div><!-- menu-item -->
        </a><!-- br-menu-link -->
        ...
        <a href="#" class="br-menu-link" onclick="cargaContenido('blog.php')">
          <div class="br-menu-item">
            <i class="menu-item-icon  icon ion-ios-list-outline tx-22"></i>

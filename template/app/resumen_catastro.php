...
<div class="br-pageheader pd-y-15 pd-l-20">
  <nav class="breadcrumb pd-0 mg-0 tx-12">
    ...
    <span class="breadcrumb-item active">Catastro</span>
  </nav>
</div><!-- br-pageheader -->
<div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
  <h4 class="tx-gray-800 mg-b-5">Catastro</h4>
  <p class="mg-b-0"></p>
</div>
      ...
      <table id="datatableUbicaciones" class="table display responsive nowrap">
        <thead>
          <tr>
            ...
            <th class="wd-10p">Fecha de ingreso</th>
            <th class="wd-10p">Folio </th>
            <th class="wd-10p">Fecho de registro</th>
  ...
  <div class="modal-dialog modal-dialog-vertical-center modal-lg" role="document">
    <div class="modal-content bd-0 tx-14">
      ...
      <div class="modal-header pd-y-20 pd-x-25">
        <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Catastro</h6>
          ...
          <div class="content">    
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                 ...
                 <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label">Fecho de registro:</label>
                        <input class="form-control valid" type="date" name="apellido_materno" required="true" placeholder="" aria-required="true"  value="<?=$apellido_materno?>">
                    </div>
                </div>

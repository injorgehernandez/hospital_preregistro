...
<div class="br-pageheader pd-y-15 pd-l-20">
  <nav class="breadcrumb pd-0 mg-0 tx-12">
    <a class="breadcrumb-item active" href="index.php">Inicio</a>
  </nav>
</div><!-- br-pageheader -->
<div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
  <h4 class="tx-gray-800 mg-b-5">Resumen de Pre-Registros Pendientes</h4>
  <p class="mg-b-0"></p>
</div>
            ...
            <div class="row">
             ...
             <div class="row">
              <div class="header col-md-12">
                ...
                <div class="col-lg-4">
                  <label class="ckbox">
                    <input type="checkbox"><span>Documento 1</span>
                  </label>
                  <a href="">Ver documento</a>
                </div><!-- col-3 -->
                <div class="col-lg-4">
                  <label class="ckbox">
                    <input type="checkbox"><span>Documento 2</span>
                  </label>
                  <a href="">Ver documento</a>
                </div><!-- col-3 -->
                <div class="col-lg-4">
                  <label class="ckbox">
                    <input type="checkbox"><span>Documento 3</span>
                  </label>
                  <a href="">Ver documento</a>
                </div><!-- col-3 -->
                <br>
                 ...
                 <input id="guardar" type="submit" name="" class="btn btn-primary tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium" value="Imprimir expediente"> 

...
<div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
  <h4 class="tx-gray-800 mg-b-5">Pagos</h4>
  <p class="mg-b-0"></p>
</div>
  ...
  <div class="modal-dialog modal-dialog-vertical-center modal-lg" role="document">
    <div class="modal-content bd-0 tx-14">
      ...
      <div class="modal-header pd-y-20 pd-x-25">
        <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Pagos</h6>
        ...
        <div class="form-layout">
          ...
          <div class="content">    
                ...
                <table id="datatableUbicaciones3" class="table display responsive nowrap">
                  ...
                  <tbody>
                      <tr>
                       ...
                       <td><a href="#"  class="btn btn-simple btn-danger btn-icon delete" ><i class="fa fa-trash"></i></a>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="control-label">Pago extra:</label>
      ...
      <div class="modal-footer">
        ...
        <input id="guardar" type="submit" name="" class="btn btn-primary tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium" value="Exportar pago"> 
        <input id="guardar" type="submit" name="" class="btn btn-primary tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium" value="Enviar a pago"> 
      </div>

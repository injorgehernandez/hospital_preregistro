...
<div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
  <h4 class="tx-gray-800 mg-b-5">Resumen de Clientes</h4>
  <p class="mg-b-0"></p>
</div>
      ...
      <table id="datatableUbicaciones" class="table display responsive nowrap">
        <thead>
          <tr>
            ...
            <th class="wd-30p">Giro</th>
            <th class="wd-20p">Controversias</th>
  ...
  <div class="modal-dialog modal-dialog-vertical-center modal-lg" role="document">
    <div class="modal-content bd-0 tx-14">
      ...
      <div class="modal-header pd-y-20 pd-x-25">
        <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Nueva controversia</h6>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="control-label">Cliente a demandar</label>
        ...
        <div class="form-layout">
          ...
          <div class="content">    
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="control-label">* Cálculo aproximado</label>

      ...
      <table id="datatableUbicaciones" class="table display responsive nowrap">
        ...
        <tbody>
            <tr>
             ...
             <td>
                  <a href="" data-toggle="modal" data-target="#modaldemo1" class="btn btn-simple btn-icon" onclick="cargaContenido('nueva_elaboracion.php')"><i class="fa fa-eye"></i></a>
  ...
  <div class="modal-dialog modal-dialog-vertical-center modal-lg" role="document">
    <div class="modal-content bd-0 tx-14">
      ...
      <div class="modal-header pd-y-20 pd-x-25">
        <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Elaboración-Validación</h6>
        ...
        <div class="form-layout">
          ...
          <div class="content">    
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="control-label">Folio de catastro:</label>
